...
export function ShareCard({ agents, pendingActions, accomplishments, isDemoMode, onClose }: ShareCardProps) {
  ...
  const generateCard = useCallback(() => {
    ...
    ctx.fillText('🏢 clawharbor', W / 2, 75);
    ...
    ctx.fillText('clawharbor.work/demo — Try it in 10 seconds ✨', W / 2, H - 35);
  ...
  const handleDownload = () => {
    ...
    link.download = 'my-clawharbor.png';
    link.href = imageUrl;
    link.click();
  };
