...
/**
 * Read clawharbor.config.json for display overrides (colors, NPC appearance, etc.)
 */
 ...
 * Merges optional overrides from clawharbor.config.json.
 */
...
function resolveJobTarget(job: any): string {
  ...
  if (combined.includes('pixel') || combined.includes('clawharbor')) return 'clawharbor';
