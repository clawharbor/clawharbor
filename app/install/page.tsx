      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            This will clone the repo to <code style={{ background: '#1e293b', padding: '2px 6px', borderRadius: 3 }}>~/clawharbor/</code>, install dependencies, and create the launcher.
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            clawharbor auto-discovers agents from your OpenClaw installation:
          </p>
        ...
        <div style={{
          ...
          <p style={{
            ...
            Tell your OpenClaw agent to install clawharbor, and it will run the installer for you.
          </p>
        </div>
        ...
        <div style={{
          ...
          <a href="https://github.com/clawharbor/clawharbor/security" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', fontSize: 13 }}>
            <a href="https://github.com/clawharbor/clawharbor" style={{ color: '#6366f1', textDecoration: 'none' }}>
              GitHub
            </a>
