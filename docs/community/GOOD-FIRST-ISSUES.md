...
**Sections:**
1. **Intro** (30 sec): What is clawharbor?
...
### 7. Write "How clawharbor Works" technical deep-dive
**Difficulty:** Medium (2 hours)  
**Impact:** Helps contributors understand architecture

**Description:**
Create `ARCHITECTURE.md` explaining how clawharbor discovers agents and displays status.
