...
**Status**: Are we actually ready to launch clawharbor?
...
### Product
- [x] Demo works: clawharbor.work/?demo=true
...
- [x] Demo GIF created: public/clawharbor-demo.gif
...
- [x] Domain working: clawharbor.work
...
- [ ] Demo link works: clawharbor.work/?demo=true
- [ ] GIF is attached (clawharbor-demo.gif)
