...
**clawharbor isn't just functional — it's FUN.**
...
### Agent Naming
You can rename agents in `clawharbor.config.json`:
```json
{
  "agents": {
    "scout": {
...
When you check clawharbor and see:
...
**Tag**: @__tfresh + #clawharbor

**Example**: "Just discovered that agents actually TURN to face each other at the water cooler in @__tfresh's clawharbor. The attention to detail! 🎨"
