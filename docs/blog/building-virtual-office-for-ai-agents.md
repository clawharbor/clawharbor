...
**clawharbor** is an open-source OpenClaw skill that turns your agent dashboard into a retro RPG office. Here's what's in it:
...
Or try the demo: [clawharbor.work/?demo=true](https://clawharbor.work/?demo=true)
...
- **Install:** OpenClaw skill system (`npx clawharbor` or `clawhub install clawharbor`)

Everything is open source: [github.com/clawharbor/clawharbor](https://github.com/clawharbor/clawharbor)
...
*Try it: [clawharbor.work](https://clawharbor.work)*
