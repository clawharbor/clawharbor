...
**Complete reference for clawharbor API endpoints.**

Use these APIs to integrate clawharbor with other tools, build custom UIs, or automate agent management.
  ...
  "agents": [
    {
      ...
      "activity": "Building clawharbor features",
      "room": "work",
...
**Path:** `~/clawharbor/clawharbor.config.json` or `~/.openclaw/clawharbor.config.json`
...
**Track:** https://github.com/clawharbor/clawharbor/issues/42
...
**Note:** These files are read/written by clawharbor. Manual edits are supported but not recommended (use API instead).
...
- [CONTRIBUTING.md](../CONTRIBUTING.md) — Contributing to clawharbor

---

**Last updated:** Feb 24, 2026  
**Version:** 1.0.0+  
**Maintainer:** clawharbor community
