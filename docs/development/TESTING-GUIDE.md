...
Essential checks to verify clawharbor is working:

```bash
# 1. Start dev server
cd ~/clawd-clawharbor/clawharbor
npm run dev
...
# Look for: "🎮 Demo Mode — Try clawharbor!"
```

**Expected behavior:**
- Banner at top with "Install clawharbor" button
...
**clawharbor is working correctly when:**
...
**Maintained by:** clawharbor community
