# Your First 5 Minutes with clawharbor
...
- That's normal! clawharbor shows agents from `~/.openclaw/openclaw.json`
- Only agents with workspaces show up
- Try the [demo mode](https://clawharbor.work/?demo=true) to see it fully populated
...
A: No, clawharbor is a dashboard for OpenClaw agents. Install OpenClaw first: https://docs.openclaw.ai
...
A: clawharbor auto-discovers from OpenClaw config. Add agents via `openclaw agent add` command.
...
- **Bug reports:** [GitHub Issues](https://github.com/clawharbor/clawharbor/issues)
- **Questions:** [Discord](https://discord.com/invite/clawd) #clawharbor channel

---

**Made it through 5 minutes?** You now understand 80% of clawharbor. The rest is discovering fun interactions and building your own workflows. Enjoy! 🎮
