# Contributing to clawharbor

Thanks for your interest in contributing to clawharbor! 🎉
...
2. **Clone your fork:**
   ```bash
   git clone https://github.com/YOUR_USERNAME/clawharbor.git
   cd clawharbor
   ```
...
Found a bug? [Open an issue](https://github.com/clawharbor/clawharbor/issues/new) with:
...
Have an idea? [Open an issue](https://github.com/clawharbor/clawharbor/issues/new) with:
- The problem you're trying to solve
- Your proposed solution
- Why this would make clawharbor better
...
**Before You Start:**
1. Check [existing issues](https://github.com/clawharbor/clawharbor/issues) to avoid duplicates
...
**Stuck? Need guidance?**
- Open a [GitHub Discussion](https://github.com/clawharbor/clawharbor/discussions)
...
By submitting a pull request, you agree to our [Contributor License Agreement](./CLA.md). This allows us to keep clawharbor open source under AGPL-3.0 while also offering commercial licenses to sustain the project.
...
Every contribution—no matter how small—makes clawharbor better. Whether you're fixing a typo, adding a feature, or suggesting an idea, **you're helping build something cool.**
