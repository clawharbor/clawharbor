...
# clawharbor Demo GIF Creation Helper
# This script helps automate GIF creation from screen recording

set -e

echo "🎬 clawharbor Demo GIF Creator"
echo "================================="
echo ""
...
INPUT_VIDEO="$1"
OUTPUT_DIR="public"
OUTPUT_FILE="$OUTPUT_DIR/clawharbor-demo.gif"
OUTPUT_MOBILE="$OUTPUT_DIR/clawharbor-demo-mobile.gif"
