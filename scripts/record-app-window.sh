#!/bin/bash
# Record clawharbor in an isolated Chrome app window
...
# Function to open clawharbor in isolated Chrome app window
        ...
        tell process "Google Chrome"
          ...
          repeat with w in windowList
            try
              ...
              if windowTitle contains "localhost:3333" or windowTitle contains "clawharbor" then
