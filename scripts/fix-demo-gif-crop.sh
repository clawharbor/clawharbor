...
ffmpeg -y -i public/clawharbor-demo.gif \
  -vf "crop=560:500:0:0,split[s0][s1];[s0]palettegen[p];[s1][p]paletteuse" \
  public/clawharbor-demo-cropped.gif
...
# Check file sizes
original_size=$(stat -f%z public/clawharbor-demo.gif)
cropped_size=$(stat -f%z public/clawharbor-demo-cropped.gif)
...
open public/clawharbor-demo-cropped.gif

echo ""
echo "🤔 Review the cropped GIF. Does it look good?"
echo ""
echo "If YES:"
echo "  mv public/clawharbor-demo-cropped.gif public/clawharbor-demo.gif"
echo "  git add public/clawharbor-demo.gif"
echo "  git commit -m 'fix: Crop demo GIF to remove meta-discussion'"
echo ""
echo "If NO:"
echo "  rm public/clawharbor-demo-cropped.gif"
