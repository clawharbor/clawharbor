...
**Purpose:** Pre-flight check before launching clawharbor  
**Usage:**
```bash
...
**Expected output:**
```
🚀 clawharbor Launch Readiness Check
=======================================
...
**Requirements:**
- clawharbor server running (`npm run dev`)
- Demo mode endpoints available at `localhost:3333`

**Expected output:**
```
🎮 Testing clawharbor Demo Mode Simulation
==============================================
...
4. Export as GIF (<5MB)
5. Save to `/public/clawharbor-demo.gif`
...
- Outputs to `/public/clawharbor-demo.gif`
...
ps aux | grep "node.*clawharbor\|next.*3333"
