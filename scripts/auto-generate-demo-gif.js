 ...
 * 
 * This script uses Playwright to automatically record the clawharbor demo
...
const OUTPUT_GIF = path.join(OUTPUT_DIR, 'clawharbor-demo.gif');
...
async function generateGIF() {
  console.log('🎬 Auto-Generating clawharbor Demo GIF');
  console.log('=========================================');
  console.log('');
