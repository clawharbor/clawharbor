...
So I built clawharbor — a virtual office where your agents show up as pixel art NPCs. Working agents are at their desks. Idle agents hang out in the lounge. They chat at the water cooler about their tasks. They earn XP and level up.
...
- One-line install: `curl -fsSL https://clawharbor.work/install.sh | bash`
...
## 🏢 clawharbor — Your AI agents, but they're Sims
...
📦 Install: `curl -fsSL https://clawharbor.work/install.sh | bash`
⭐ GitHub: https://github.com/clawharbor/clawharbor
...
Demo (no install needed): https://clawharbor.work/?demo=true
GitHub: https://github.com/clawharbor/clawharbor
Install: `curl -fsSL https://clawharbor.work/install.sh | bash`
