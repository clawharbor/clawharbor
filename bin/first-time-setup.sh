#!/bin/bash
# First-time setup wizard for clawharbor
...
echo ""
echo -e "${BLUE}🏢 clawharbor First-Time Setup${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
if [ ! -f "$OPENCLAW_CONFIG" ]; then
  ...
  echo ""
  echo "clawharbor works best with OpenClaw installed."
...
CONFIG_FILE="$PWD/clawharbor.config.json"
...
echo ""
read -p "Start clawharbor now? (Y/n) " -n 1 -r
echo ""

if [[ ! $REPLY =~ ^[Nn]$ ]]; then
  echo ""
  echo -e "${BLUE}Starting clawharbor...${NC}"
  ...
  echo "Run 'clawharbor' when you're ready!"
fi
